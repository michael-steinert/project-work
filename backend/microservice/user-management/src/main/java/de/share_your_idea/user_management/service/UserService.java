...
public class UserService {
    ...
    public UserEntity getUserByUsername(String username) {
        log.info("CustomerService: Fetch User by Username");
        UserEntity userEntity = restTemplate.getForObject("http://USER-REGISTRATION-SERVICE/user-authentication/fetch-user-by-username/" + username, UserEntity.class);
        userDao.insertUser(UserEntity.newUser(UUID.randomUUID(), userEntity));
        return userEntity;
    }
}